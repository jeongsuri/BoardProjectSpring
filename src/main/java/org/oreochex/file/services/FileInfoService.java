...
import org.oreochex.file.entities.QFileInfo;
import org.oreochex.file.exceptions.FileNotFoundException;
import org.oreochex.file.repositories.FileInfoRepository;
import org.oreochex.global.configs.FileProperties;
...
public class FileInfoService {
    ...
    public String getFileName(FileInfo item) {
        String fileName = item.getSeq() + Objects.requireNonNullElse(item.getExtension(), ""); //파일명 + 확장자
        return fileName;
    }
}